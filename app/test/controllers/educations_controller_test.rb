...
class EducationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create education" do
    assert_difference('Education.count') do
      post educations_url, params: { education: { name: @education.name, qualification: @education.qualification } }
    end
  ...
  test "should update education" do
    patch education_url(@education), params: { education: { name: @education.name, qualification: @education.qualification } }
